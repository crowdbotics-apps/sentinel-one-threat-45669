"""
Django settings for sentinel_one_threat_45669 project.
...
ROOT_URLCONF = 'sentinel_one_threat_45669.urls'
...
WSGI_APPLICATION = 'sentinel_one_threat_45669.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sentinel_one_threat_45669 API",
    "DESCRIPTION": "API documentation for sentinel_one_threat_45669 App",
    "VERSION": "v1",
}
